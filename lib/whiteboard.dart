...
import 'package:whiteboardkit/whiteboardkit%20copy.dart';
...
class WhiteboardState extends State<Whiteboard> {
  ...
  void initState() {
    ...
    toolboxOffset = showToolBox ?? false ? HEIGHT_TO_SUBSTRACT : 0;
                  ...
                  child: GestureDetector(
                    ...
                    child: StreamBuilder<WhiteboardDraw>(
                        ...
                        builder: (context, snapshot) {
                          WhiteboardDraw? draw = snapshot.data;
...
class SuperPainter extends CustomPainter {
  ...
  bool shouldRepaint(SuperPainter oldDelegate) =>
      ...
      oldDelegate.visibleLines.fold(
              0, (total, l) => l.points.length + int.parse(total.toString())) !=
          visibleLines.fold(
              0, (total, l) => l.points.length + int.parse(total.toString()));
}
